...
public class LW extends I_type{
     ...
     */
    public LW(int instr_addr, String ac, String[] ac_split){
    ...
    protected void decipherAssembly(){
        ...
        opCode[0] = opCode[4] = opCode[5] = true;
    }
}
