...
public class NOR extends R_type{
     ...
     */
    public NOR(int instr_addr, String ac, String[] ac_split){
    ...
    protected void decipherAssembly(){
        ...
        funct[0] = funct[3] = funct[4] = funct[5] = true;
    }
}
