...
/**
 * Class describing the MIPS 'Set on Less Than Immediate Unsigned' instruction
 * @author Alexander Eick (620),    alexander.eick@outlook.de
 * @author Leandro Pessoa (741),    leandroeliasster@gmail.com
 */
public class SLTIU extends I_type{
     ...
     */
    public SLTIU(int instr_addr, String ac, String[] ac_split){
    ...
    protected void decipherAssembly(){
        ...
        opCode[2] = opCode[4] = opCode[5] = true;
    }
}
