...
public class SW extends I_type{
     ...
     */
    public SW(int instr_addr, String ac, String[] ac_split){
    ...
    protected void decipherAssembly(){
        ...
        opCode[0] = opCode[2] = opCode[4] = opCode[5] = true;
    }
}
