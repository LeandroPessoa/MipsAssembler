...
public class SLTU extends R_type{
     ...
     */
    public SLTU(int instr_addr, String ac, String[] ac_split){
    ...
    protected void decipherAssembly(){
        ...
        funct[0] = funct[2] = funct[4] = funct[5] = true;
    }
}
